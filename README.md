...
[![Award](https://img.shields.io/badge/Award-Innovation%20Award%20%E2%80%94%20ArcelorMittal%20Europe%202025-gold)](https://github.com/ihauss)
...
🎥 **Demo Video:** [Watch the system in action](https://youtu.be/raMdoFbxsjw)
...
1. **Camera Ingestion** – 5 standard security cameras stream RTSP video into ROS2 nodes.
2. **Production Line Detection** – YOLOv8 identifies the rolling mill area of interest.
3. **Anomaly Detection** – HSV filtering + KNN background subtractor highlights any unexpected movement/objects in the line.
4. **False Alarm Filtering** – A ResNet classifier distinguishes real cobbles from benign anomalies (e.g., steam, lighting changes, scale drops).
5. **Alert Trigger** – If a real cobble is confirmed, an **instant alert** is sent to the control room and field workers (audible/visual).
...
|----------------------|-------------|
| 🎥 [Demo Video](https://youtu.be/raMdoFbxsjw) | Live demonstration of the system detecting a cobble and triggering an alert. |
...
- **Contact:** [ismael.hauss@gmail.com](mailto:ismael.hauss@gmail.com) – I'm happy to discuss the technical details or collaboration opportunities.
